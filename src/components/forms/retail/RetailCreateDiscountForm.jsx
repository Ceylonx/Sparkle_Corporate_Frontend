...
import { createRetailDiscount } from "../../../services/Retail/RetailDiscountServices";
import { BeatLoader } from "react-spinners";

const RetailCreateDiscountForm = ({ handleClose, refreshDiscounts }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            auto_apply: formData.auto_apply ? 1 : 0,
            status: "Active",
        };

        try {
            setIsLoading(true);
            const response = await createRetailDiscount(payload);
            handleClose();
            refreshDiscounts();
        } catch (error) {
...
export default RetailCreateDiscountForm;